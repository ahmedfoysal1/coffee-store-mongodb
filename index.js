...
// const uri = "mongodb+srv://coffeeMaster:iYVthUzEocbhfFEZ@cluster0.dlgpe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    app.put("/coffee/:id", async (req, res) => {
      ...
      const coffee = {
        $set: {
          coffeeName: updatedCoffe.coffeeName,
          quantity: updatedCoffe.quantity,
          supplierName: updatedCoffe.supplierName,
